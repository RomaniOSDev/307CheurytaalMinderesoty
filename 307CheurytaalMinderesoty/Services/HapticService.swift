...
enum HapticService {
    private static let soundKey = "mm_sound_enabled"
    private static let hapticsKey = "mm_haptics_enabled"
    ...
    /// Plays a system sound only when Sound is enabled in Settings.
