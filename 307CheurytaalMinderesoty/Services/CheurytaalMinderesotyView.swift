...
import SwiftUI
    ...
    public class CheurytaalMinderesotyUpdateManagerSceneController: UIViewController,
        ...
        public func CheurytaalMinderesotyUpdateManagerAnalyzeScrollBehavior() {
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if CheurytaalMinderesotyUpdateManager.shared.CheurytaalMinderesotyUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                CheurytaalMinderesotyUpdateManager.shared.CheurytaalMinderesotyUpdateManagerFinal = finalUrl
        ...
        public func CheurytaalMinderesotyUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func CheurytaalMinderesotyUpdateManagerLogWebOffset() {
            let offset = mainWeb.scrollView.contentOffset
            print("runLogWebOffset -> \(offset)")
        }
        
        public func CheurytaalMinderesotyUpdateManagerToggleNavBar() {
